...
const doScrap = async () => {
  ...
  try {
    ...
    const url = 'https://mi.tv/cl/canales/hbo-2';
    ...
    if(programacion.length > 0){
      ...
      fs.writeFileSync("/home/deltafoxtrot/flytvtools/"+"hbo2.json", jsonData);
