...
const doScrap = async () => {
  ...
  try {
    ...
    const url = 'https://mi.tv/cl/canales/max-up';
    ...
    if(programacion.length > 0){
      ...
      fs.writeFileSync("/home/deltafoxtrot/flytvtools/"+"hbopop.json", jsonData);
