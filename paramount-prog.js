...
const doScrap = async () => {
  ...
  try {
    ...
    const url = 'https://mi.tv/cl/canales/paramount-channel-hd';
    ...
    if(programacion.length > 0){
      ...
      fs.writeFileSync("/home/deltafoxtrot/flytvtools/"+"paramount.json", jsonData);
