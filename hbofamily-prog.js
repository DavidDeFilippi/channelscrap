...
const doScrap = async () => {
  ...
  try {
    ...
    const url = 'https://mi.tv/cl/canales/hbo-family';
    ...
    if(programacion.length > 0){
      ...
      fs.writeFileSync("/home/deltafoxtrot/flytvtools/"+"hbofamily.json", jsonData);
