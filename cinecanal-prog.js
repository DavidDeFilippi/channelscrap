...
const doScrap = async () => {
  ...
  try {
    ...
    const url = 'https://mi.tv/cl/canales/cinecanal';
    ...
    if(programacion.length > 0){
      ...
      fs.writeFileSync("/home/deltafoxtrot/flytvtools/"+"cinecanal.json", jsonData);
