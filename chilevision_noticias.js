...
const config = {
  ...
  // headless: false,
  devtools: true, // Open the devtools panel in a non headless mode
...
const doScrap = async () => {
  ...
  try {
    ...
    const url = 'https://rudo.video/live/chvn';
    ...
    if (interceptedURL !== undefined) {
      fs.writeFileSync("/home/deltafoxtrot/flytvtools/093bd8d5ea67eecf27813b1cf3de2ffe.txt", interceptedURL);
    }
